            ...
            <tbody>
              ...
              <tr>
                <td colSpan={10} style={{ height: "0.1in", fontSize: "55%" }}>
                  <i>
                    ...
                    >
                      Registration No:&nbsp;
                      <span style={{ color: "red" }}>{"2147483647"}</span>
                    </b>
                  </i>
                </td>
                ...
                >
                  ...
                  >
                    Academic Year/Term :{}
                    <span style={{ color: "red" }}>{"Second Semester AY 2024-2025"}</span>
                  </b>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                >
                  <input
                    type="text"
                    value={"NAVIDAD, KATHERINE GENE JIMENEZ"}
                    style={{
                      color: "black",
                      width: "98%",
                      fontFamily: "Arial, sans-serif",
              ...
              <tr>
                ...
                >
                  <input
                    type="text"
                    value={"navidad.kg.bsinfotech@gmail.com"}
                    style={{
                      color: "black",
                      width: "98%",
                      border: "none",
